 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const B_=5*60,$_=ml("authIdTokenMaxAge")||B_;let Aa=null;const H_=e=>async t=>{const n=t&&await t.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>$_)return;const s=n==null?void 0:n.token;Aa!==s&&(Aa=s,await fetch(e,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function j_(e=Ug()){const t=bl(e,"auth");if(t.isInitialized())return t.getImmediate();const n=Em(e,{popupRedirectResolver:M_,persistence:[qm,Mm,Kl]}),r=ml("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=H_(i.toString());xm(n,o,()=>o(n.currentUser)),Om(n,c=>o(c))}}const s=pl("auth");return s&&Sm(n,`http://${s}`),n}function V_(){var e,t;return(t=(e=document.getElementsByTagName("head"))===null||e===void 0?void 0:e[0])!==null&&t!==void 0?t:document}vm({loadJS(e){return new Promise((t,n)=>{const r=document.createElement("script");r.setAttribute("src",e),r.onload=t,r.onerror=s=>{const i=ze("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",V_().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});F_("Browser");const W_=[{path:"/",component:()=>Vt(()=>import("./LandingPage.1b48d51c.js"),["assets/LandingPage.1b48d51c.js","assets/QCard.63db5039.js","assets/QBtn.3017b0bb.js","assets/auth.5b5ad50b.js","assets/firebase.a8ab39df.js"])},{path:"/chats",component:()=>Vt(()=>import("./MainLayout.e769fed7.js"),["assets/MainLayout.e769fed7.js","assets/QLayout.eb2fdc97.js","assets/QBtn.3017b0bb.js","assets/scroll.e732c370.js","assets/QAvatar.095d86d8.js","assets/auth.5b5ad50b.js","assets/firebase.a8ab39df.js"]),meta:{requiresAuth:!0},children:[{path:"",component:()=>Vt(()=>import("./ChatsPage.ae62ab88.js"),["assets/ChatsPage.ae62ab88.js","assets/QBtn.3017b0bb.js","assets/firebase.a8ab39df.js","assets/QAvatar.095d86d8.js","assets/auth.5b5ad50b.js","assets/QInput.94d16954.js","assets/OverlappingAvatars.d66d942c.js","assets/OverlappingAvatars.19edd09d.css","assets/room.b3cc457d.js","assets/QCard.63db5039.js","assets/scroll.e732c370.js"])}]},{path:"/chat",component:()=>Vt(()=>import("./ChatLayout.3e95e4ee.js"),["assets/ChatLayout.3e95e4ee.js","assets/QBtn.3017b0bb.js","assets/QAvatar.095d86d8.js","assets/auth.5b5ad50b.js","assets/firebase.a8ab39df.js","assets/QLayout.eb2fdc97.js","assets/scroll.e732c370.js","assets/room.b3cc457d.js","assets/OverlappingAvatars.d66d942c.js","assets/OverlappingAvatars.19edd09d.css"]),meta:{requiresAuth:!0},children:[{path:":id",component:()=>Vt(()=>import("./ChatPage.ff37fda8.js"),["assets/ChatPage.ff37fda8.js","assets/QAvatar.095d86d8.js","assets/auth.5b5ad50b.js","assets/firebase.a8ab39df.js","assets/QBtn.3017b0bb.js","assets/QInput.94d16954.js","assets/room.b3cc457d.js"])}]},{path:"/:catchAll(.*)*",component:()=>Vt(()=>import("./ErrorNotFound.fbf755fa.js"),["assets/ErrorNotFound.fbf755fa.js","assets/QBtn.3017b0bb.js"])}];var ks=function(){const t=hp({scrollBehavior:()=>({left:0,top:0}),routes:W_,history:Vh("/")});return t.beforeEach((n,r,s)=>{const i=j_();n.matched.some(c=>c.meta.requiresAuth)&&!i.currentUser?s("/"):n.path==="/"&&i.currentUser?s("/chats"):s()}),t};async function z_(e,t){const n=e(ch);n.use(ah,t);const r=typeof ys=="function"?await ys({}):ys;n.use(r);const s=Xn(typeof ks=="function"?await ks({store:r}):ks);return r.use(({store:i})=>{i.router=s}),{app:n,store:r,router:s}}var K_={config:{}};const q_="/";async function G_({app:e,router:t,store:n},r){let s=!1;const i=a=>{try{return t.resolve(a).href}catch{}return Object(a)===a?null:a},o=a=>{if(s=!0,typeof a=="string"&&/^https?:\/\//.test(a)){window.location.href=a;return}const l=i(a);l!==null&&(window.location.href=l,window.location.reload())},c=window.location.href.replace(window.location.origin,"");for(let a=0;s===!1&&a<r.length;a++)try{await r[a]({app:e,router:t,store:n,ssrContext:null,redirect:o,urlPath:c,publicPath:q_})}catch(l){if(l&&l.url){o(l.url);return}console.error("[Quasar] boot error:",l);return}s!==!0&&(e.use(t),e.mount("#q-app"))}z_(Ld,K_).then(e=>{const[t,n]=Promise.allSettled!==void 0?["allSettled",r=>r.map(s=>{if(s.status==="rejected"){console.error("[Quasar] boot error:",s.reason);return}return s.value.default})]:["all",r=>r.map(s=>s.default)];return Promise[t]([Vt(()=>import("./firebase.a8ab39df.js").then(function(r){return r.n}),[])]).then(r=>{const s=n(r).filter(i=>typeof i=="function");G_(e,s)})});export{ev as $,He as A,Xf as B,vn as C,Iv as D,Sv as E,Ut as F,At as G,J_ as H,sv as I,dv as J,uv as K,oe as L,fv as M,av as N,iv as O,yc as P,lv as Q,cv as R,sr as S,tv as T,Qr as U,cf as V,Z_ as W,Vc as X,pu as Y,Xe as Z,Jn as _,Ug as a,Yt as a0,Kn as a1,rc as a2,We as a3,mv as a4,_r as a5,hv as a6,mr as a7,pv as a8,bn as a9,bc as aa,Q_ as ab,th as ac,Xu as ad,Do as ae,Pi as af,Y_ as ag,et as ah,ov as ai,Z as aj,X_ as ak,tf as al,gv as am,Vd as an,Qu as ao,qd as ap,di as aq,yv as ar,nv as as,bl as b,bv as c,wv as d,_l as e,Or as f,Ft as g,Te as h,Ev as i,_v as j,Lg as k,rv as l,Ri as m,Wr as n,Ci as o,Hc as p,j_ as q,Ln as r,Tv as s,bi as t,vv as u,vc as v,Wu as w,ke as x,qf as y,cn as z};
